...
**IMPORTANT**: the challenge must be written in React and TypeScript. You can choose any libraries that you find useful, but every decision must be justified.
...
### Assets
You can find the layout mockups here on this Figma project:
[Layout mockups](https://www.figma.com/file/iJQFZbP0BV8iy9oL3kWKbb/azeti-take-home-assignment?node-id=0%3A1)
